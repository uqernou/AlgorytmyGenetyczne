...
with open(r"C:\Users\uqern\Desktop\AG_banner\a_0.txt") as fobj:
    for line in fobj:
        row = line.split()
        x_banner.append(row[0])
        y_banner.append(row[1])

with open(r"C:\Users\uqern\Desktop\AG_banner\t_0.txt") as fobj:
    for line in fobj:
        row = line.split()
...
def update(i):
    ...
    with open(r"C:\Users\uqern\Desktop\AG_banner\a_" + str(i) + ".txt") as fobj:
        for line in fobj:
            row = line.split()
            x_banner.append(row[0])
            y_banner.append(row[1])
...
ani = animation.FuncAnimation(fig, update, repeat=True, frames=99, interval=100, blit=False)
f = r"C:\Users\uqern\Desktop\AG_banner\animation.gif"
